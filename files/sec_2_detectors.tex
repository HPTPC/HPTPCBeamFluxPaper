...
Because of the low frequency of start-of-spill signal it is possible to use it, along with the DAQ file timestamps, to ensure that all spills are matched in both DAQs.
...
\begin{figure}[ht]
  ...
  \end{adjustbox}
  \caption{Angular position of various objects within the T10 beamline. The origin in this view is at the centre of $\mathit{S1}$; the true centre of the steered beam is at +1$^{\circ}$ in $\theta$ and 0$^{\circ}$ in $\phi$.}
