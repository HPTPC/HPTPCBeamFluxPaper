...
The TPC was placed 13~m downstream of the BPM and XXX m away from the beam centre, so that the TPC active region spanned off-axis angles 1.4--3.8$^{ \circ }$.
...
An example of the $t_{ave}$ distribution for one run of $\mathit{S1}$ data is shown in figure~\ref{fig:s3Res}. The FWHM of the distribution is XXX ps.
\begin{figure}
  \centering
  \includegraphics[width=0.6\linewidth]{files/Figures/TrTimeRes.pdf}
...
In order to calculate the correct time of flight, timing delays caused by cabling and equipment are taken into account.
...
An example of one of these distributions is shown is figure~\ref{fig:s4PosEff}.
