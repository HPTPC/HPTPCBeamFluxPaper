...
\begin{figure}[t]
  ...
  \begin{minipage}[t]{0.49\textwidth}
    ...
    \end{adjustbox}
    \caption{Reconstructed spatial distribution of hits observed in $\mathit{S3}$. In this case a timing cut and an amplitude cut has been applied to select only those hits thought to come from protons. These data were taken with 4 moderator blocks in the beamline.}
