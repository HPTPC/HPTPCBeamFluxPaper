...
\subsection{Analysis Methods}
	...
	Similarly to figure~\ref{fig:s4tof}, the quicker peak is thought to be formed by minimum ionizing particles, while the peak at higher values of $S3 - S1$ is thought to be caused by protons.
