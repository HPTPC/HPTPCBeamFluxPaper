...
\begin{figure}[ht]
  ...
  \caption{Examples of SiPM signal amplitude plotted against $\mathit{S1}$ to $\mathit{S3}$ time of flight for different numbers of moderator blocks. Clockwise from top left 0, 1, 3 and 2 moderator blocks are shown. The red dashed line shows the amplitude cut used for this particular SiPM. A1 is the voltage recorded in the SiPM at the end of the bar. The population at lower values of $t_{\mathit{S3}}-t_{\mathit{S1}}$ is caused by MIPs while the population at higher values of $t_{\mathit{S3}}-t_{\mathit{S1}}$ is caused by protons.}
  \label{fig:TvsA}
\end{figure}
