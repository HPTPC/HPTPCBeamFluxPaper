...
The $\mathit{S2}$ counter is a scintillator tile of size $120\times120\times5$~mm$^3$, coupled to a 2" PMT R1309, via a long light-guide as shown in figure~\ref{fig:modblocks}.
...
The analog signals from one of the $\mathit{S1}$ PMTs and the $\mathit{S2}$ PMT were fed into NIM discriminator units with a threshold of 30~mV.
