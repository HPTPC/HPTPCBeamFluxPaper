...
\todo[inline]{Need moderator block distance from S1 if we have it -- This wasn't part of the survey, I'm not sure this measurement exists.}
...
The coordinate axes are defined as follows: $x$ refers to the non-beam horizontal direction, $y$ to the vertical direction, and $z$ the beam direction.
...
Figure~\ref{fig:angularDistS1} shows the angular distribution of various objects within the beamline using the coordinate system defined above.
...
\end{figure}
The beam counters $\mathit{S1}$ and $\mathit{S2}$ are shown in figure~\ref{fig:S1S2headon}, right.
