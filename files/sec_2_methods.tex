...
\begin{table}
  ...
  \begin{tabular}{|c|c|c|c|c|}
      \hline
      \multicolumn{5}{|c|}{Distance between various objects} \\
      \hline
      $\mathit{S1}-\mathit{S2}$ & $\mathit{S1}-\mathit{S3}$ & $\mathit{S3}$ - TPC drift volume &TPC drift volume - $\mathit{S4}$ & $\mathit{S2}-\mathit{S4}$  \\
      $(1.4188\pm)~\text{m}$ & $(10.7556\pm)~\text{m}$ & $(1.87072\pm)~\text{m}$ & $(1.46752\pm)~\text{m}$ & $(12.651\pm)~\text{m}$ \\
      \hline
  \end{tabular}
\end{table}
