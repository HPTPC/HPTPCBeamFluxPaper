...
\label{hptpcPaper:sec:Methods}
    ...
    The sketch of the upstream ToF detector is shown in figure \ref{ }.
...
A mean time of light signals detected at two ends of a single bar
provides a time reference with the resolution of about 100 ps, 
while the time difference gives a position of the interaction along the bar.  
An example of a reconstructed $XY$ distribution is shown in Figure \ref{ }.
