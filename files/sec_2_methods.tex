...
\begin{minipage}[b]{.46\textwidth}
    ...
    %\captionof{figure}{Front view of the downstream time of flight system}
...
\begin{minipage}[b]{.46\textwidth}
    ...
    %\captionof{figure}{Diagonal view of the downstream time of flight system showing more clearly the two rows of scintillator bars and photomultiplier tubes}
