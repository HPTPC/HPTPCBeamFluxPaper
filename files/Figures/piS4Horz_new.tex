...
\draw [anchor=base west] (5.73066,11.3053) node[scale=1.27276, color=c, rotate=0]{0 blocks - $236 \pm 4$ per spill};
\draw [c,line width=1.8] (3.78223,11.4871) -- (5.38682,11.4871);
\draw [anchor=base west] (5.73066,10.4973) node[scale=1.27276, color=c, rotate=0]{1 block - $698 \pm 5$ per spill};
\definecolor{c}{rgb}{1,0,0};
\draw [c,line width=1.8] (3.78223,10.6791) -- (5.38682,10.6791);
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (5.73066,9.68925) node[scale=1.27276, color=c, rotate=0]{2 blocks - $1049 \pm 6$ per spill};
\definecolor{c}{rgb}{0,0,1};
\draw [c,line width=1.8] (3.78223,9.87106) -- (5.38682,9.87106);
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (5.73066,8.88123) node[scale=1.27276, color=c, rotate=0]{3 blocks - $1134 \pm 9$ per spill};
\definecolor{c}{rgb}{0,0.8,0.8};
\draw [c,line width=1.8] (3.78223,9.06304) -- (5.38682,9.06304);
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (5.73066,8.07321) node[scale=1.27276, color=c, rotate=0]{4 blocks - $495 \pm 1$ per spill};
\definecolor{c}{rgb}{1,0.6,0.2};
