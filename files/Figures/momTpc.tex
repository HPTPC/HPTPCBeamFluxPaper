...
\draw [anchor=base west] (5.10029,11.4582) node[scale=1.08185, color=c, rotate=0]{0 blocks - $12.6 \pm 0.7$ / spill};
\draw [c,line width=1.8] (3.49284,11.6103) -- (4.81662,11.6103);
\draw [anchor=base west] (5.10029,10.7819) node[scale=1.08185, color=c, rotate=0]{1 block - $30.5 \pm 0.9$ / spill};
\definecolor{c}{rgb}{1,0,0};
\draw [c,line width=1.8] (3.49284,10.9341) -- (4.81662,10.9341);
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (5.10029,10.1057) node[scale=1.08185, color=c, rotate=0]{2 blocks - $56.2 \pm 1.2$ / spill};
\definecolor{c}{rgb}{0,0,1};
\draw [c,line width=1.8] (3.49284,10.2579) -- (4.81662,10.2579);
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (5.10029,9.42951) node[scale=1.08185, color=c, rotate=0]{3 blocks - $61.9 \pm 1.8$ / spill};
\definecolor{c}{rgb}{0,0.8,0.8};
\draw [c,line width=1.8] (3.49284,9.58166) -- (4.81662,9.58166);
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (5.10029,8.75329) node[scale=1.08185, color=c, rotate=0]{4 blocks - $7 \pm 0.1$ / spill};
\definecolor{c}{rgb}{1,0.6,0.2};
