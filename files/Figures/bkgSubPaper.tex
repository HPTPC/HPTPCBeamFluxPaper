...
\draw [anchor= east] (19,0.427017) node[scale=1.1, color=c, rotate=0]{$t_{\mathit{S4}} - t_{\mathit{S2}}$ [ns]};
...
\draw [anchor= east] (0.8,7.68631) node[scale=1.1, color=c, rotate=90]{ Events / spill / ns};
