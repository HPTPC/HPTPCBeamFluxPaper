...
\draw [anchor=base west] (11.1461,11.4295) node[scale=1.08185, color=c, rotate=0]{0 blocks - $12.6 \pm 0.7$ / spill};
\draw [c,line width=1.8] (9.53868,11.5817) -- (10.8625,11.5817);
\draw [anchor=base west] (11.1461,10.7533) node[scale=1.08185, color=c, rotate=0]{1 block - $30.5 \pm 0.9$ / spill};
\definecolor{c}{rgb}{1,0,0};
\draw [c,line width=1.8] (9.53868,10.9054) -- (10.8625,10.9054);
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (11.1461,10.0771) node[scale=1.08185, color=c, rotate=0]{2 blocks - $56.2 \pm 1.2$ / spill};
\definecolor{c}{rgb}{0,0,1};
\draw [c,line width=1.8] (9.53868,10.2292) -- (10.8625,10.2292);
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (11.1461,9.40086) node[scale=1.08185, color=c, rotate=0]{3 blocks - $61.9 \pm 1.8$ / spill};
\definecolor{c}{rgb}{0,0.8,0.8};
\draw [c,line width=1.8] (9.53868,9.55301) -- (10.8625,9.55301);
\definecolor{c}{rgb}{0,0,0};
\draw [anchor=base west] (11.1461,8.72464) node[scale=1.08185, color=c, rotate=0]{4 blocks - $7 \pm 0.1$ / spill};
\definecolor{c}{rgb}{1,0.6,0.2};
