...
Given the number of particles observed by the downstream time of flight with 4~moderator blocks in the beamline, simulation shows $9.82 \pm  0.14$ protons per spill reaching the TPC active region with an energy range of .
