...
The systematic uncertainty on the MC simulations is determined by varying a number of geometric initial conditions of the simulation including the position of the $\mathit{S1}$ and $\mathit{S2}$ detectors.
...
This set of calculated errors represents a number of geometric sources of uncertainty.
