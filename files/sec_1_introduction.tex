...
These distributions are highly discrepant at low proton kinetic energy as shown in the right hand panel. In the low energy region, the generators are not expected to handle hadrons correctly, due to the lack of available data.
