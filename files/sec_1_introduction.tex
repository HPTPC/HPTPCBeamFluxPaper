...
\todo[inline]{JOCELYN:"Citation needed"}
...
\todo[inline]{JOCELYN:"Citation needed for data as well as model"}
...
\end{figure}
\todo[inline]{JOCELYN:"which target, what energy, more details"}
...
\todo[inline]{JOCELYN"What neutrino flux is assumed?"}
...
\todo[inline]{JOCELYN:"before this next statement i think you need a figure (or a sentence) that shows (describes) the typical T10 beam spectrum (before we did anything with it), and explains that the low-momentum flux is negligble."}
...
\todo[inline]{JOCELYN:"Throughout the introduction, stick to proton KE or momentum (probably KE because of plots)"}
